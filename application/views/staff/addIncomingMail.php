...
<div class="container-fluid">
    ...
    <form method="post" action="<?= base_url('staff/addIncomingMail'); ?>" enctype="multipart/form-data">
        <div class="card shadow p-5 mb-5">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="nomor_surat"><span style="color: red;">* </span>Nomor Surat</label>
                        <input type="text" name="nomor_surat" class="form-control <?= (form_error('nomor_surat') ? 'is-invalid' : '') ?>" id="nomor_surat" value="<?= set_value('nomor_surat'); ?>" placeholder="Nomor surat...">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_surat" value="<?= set_value('tanggal_surat'); ?>" class="form-control <?= (form_error('tanggal_surat') ? 'is-invalid' : '') ?>" id="tanggal_surat">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sumber_surat" class="form-control <?= (form_error('sumber_surat') ? 'is-invalid' : '') ?>" id="sumber_surat" value="<?= set_value('sumber_surat'); ?>" placeholder="Sumber surat dari...">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_klasifikasi" id="id_klasifikasi" class="form-control select2 <?= (form_error('id_klasifikasi') ? 'is-invalid' : '') ?>">
                            ...
                            <?php foreach ($klasifikasi_surat as $ks) : ?>
                                <option value="<?= $ks['id']; ?>" <?= set_select('id_klasifikasi', $ks['id']); ?>>
                                    <?= $ks['nama']; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="upload-file">
                        <label for="input-file" id="drop-area">
                            ...
                            <div id="file-preview">
                                ...
                                <span>Unggah File Surat Masuk <br> ( Format yang didukung hanya PDF ) <br> dan maksimal ukuran file 5 MB.</span>
                            </div>
            ...
            <div class="row">
                <div class="col-lg">
                    <div class="form-group">
                        ...
                        <textarea name="isi_surat" class="form-control <?= (form_error('isi_surat') ? 'is-invalid' : '') ?>" id="isi_surat_masuk" rows="8" placeholder="Isi ringkasan isi surat..."><?= set_value('isi_surat'); ?></textarea>
                    </div>
                </div>
            </div>
