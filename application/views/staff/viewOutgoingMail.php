...
<div class="container-fluid">
    ...
    <!-- Datatables -->
    <h5><a style="text-decoration: none;" href="<?= base_url('staff/outgoingMail'); ?>"><i class="bi bi-arrow-left-circle-fill"></i> <small>Kembali</small></a></h5>
    <div class="card shadow view-surat-keluar mb-5 p-4">
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="alert alert-warning" role="alert">
                    <h5 class="text-uppercase font-weight-bold mb-4 mt-2">Yang Harus Dilakukan :</h5>
                    <hr class="border-dark">
                    <label class="m-0"><strong>Tindak Lanjut :</strong></label>
                    <p><?= $lihat_surat_keluar['tindak_lanjut']; ?></p>

                    <label class="m-0"><strong>Catatan :</strong></label>
