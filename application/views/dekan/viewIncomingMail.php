...
<div class="container-fluid">
    ...
    <!-- Datatables -->
    <h5><a style="text-decoration: none;" href="<?= base_url('dekan/incomingMail'); ?>"><i class="bi bi-arrow-left-circle-fill"></i> <small>Kembali</small></a></h5>
        ...
        <div class="row surat-masuk">
            <div class="col-lg-6 mb-4">
                ...
                <div class="card p-3 rounded-0">
                    ...
                    <p class="head-title">Lakukan Persetujuan Tanda Tangan Surat Disini</p>
                    <div class="isi-surat">
                        <label class="mb-0">Isi Ringkasan Surat Masuk :</label>
                        <p><?= $lihat_surat_masuk['isi_surat']; ?></p>
                        <hr>
                        <form method="post" action="<?= base_url('dekan/viewIncomingMail?id=') . $lihat_surat_masuk['id']; ?>">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary" <?= ($lihat_surat_masuk['status'] >= 4) ? 'disabled' : ''; ?>><i class="bi bi-send"></i> Kirim Data</button>
