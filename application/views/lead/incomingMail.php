                        ...
                        <?php foreach ($surat_masuk as $sm) : ?>
                            <?php if ($sm['status'] < 5) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('lead/viewIncomingMail?id=') . $sm['id']; ?>" class="btn btn-sm btn-info mb-1"><i class="bi bi-eye-fill"></i> Lihat</a>

                                        <?php if ($sm['status'] == 4 && $sm['ttd'] == 1) : ?>
                                            <a href="<?= base_url('lead/disposisiMail?id=') . $sm['id']; ?>" class="btn btn-sm btn-primary mb-1">Disposisikan <i class="bi bi-forward-fill"></i></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endif; ?>
