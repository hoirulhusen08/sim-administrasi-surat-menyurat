...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="post" action="<?= base_url('lead/manageReport'); ?>">
                <div class="row">
                    <div class="col-lg-4">
            ...
            <div class="row" style="position:absolute;z-index:9999;left:200px;">
                <div class="col-lg-12">
                    <a href="<?= base_url('lead/printAllReport?jenis_surat=' . urlencode($jenis_surat) . '&from_date=' . urlencode($from_date) . '&to_date=' . urlencode($to_date)); ?>" target="_blank" class="btn btn-sm btn-primary"><i class="bi bi-printer-fill"></i> Cetak Semua</a>
                </div>
            </div>
            <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($results as $index => $result): ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url('lead/printReport?id=') . $result['id'] . '&jenis_surat=' . urlencode($result['jenis_surat']); ?>" target="_blank" class="btn btn-sm btn-info"><i class="bi bi-printer-fill"></i> Cetak</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
