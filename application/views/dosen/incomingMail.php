...
<div class="container-fluid">
    ...
    <h4 class="m-0 mb-4"><small>Daftar Surat yang telah Terdisposisi</small></h4>
                        ...
                        <?php foreach ($surat_masuk as $sm) : ?>
                            <?php if ($sm['status'] > 1) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('dosen/downloadIncomingMailPDF?id=') . $sm['id']; ?>" class="btn btn-sm btn-danger mb-1"><i class="bi bi-download"></i> Unduh</a>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        <?php endforeach; ?>
