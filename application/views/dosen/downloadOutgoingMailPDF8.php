...
<body>
    ...
    <div class="isi-surat">
        <div class="judul">
            ...
            <p class="tentang m-0"><?= $surat_keluar['tentang_surat']; ?> Semester <?= $surat_keluar['semester']; ?></p>
            <p class="tentang m-0"><?= $setting['faculty_name']; ?></p>
            <p class="tentang m-0">Tahun Akademik <?= $surat_keluar['tahun_akademik']; ?></p>
        </div>
        <div class="konten">
    ...
    <div class="ttd-container">
        ...
        <p class="m-0" style="margin-left: 82px;"><?= date('d F Y', $surat_keluar['date_created']); ?> M</p>
        <p class="m-0">Dekan,</p>
        <div class="ttd-image">
